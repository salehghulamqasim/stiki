...
class Particle {
  ...
  Particle({required this.angle, this.speed = 1.0, this.size = 1.0});
}
...
class EnhancedStarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final glowPaint = Paint()
      ..color = primaryColor
          .withValues(alpha: glowIntensity * 0.7) // Increased opacity
...
class MyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          FallingStarWidget(startY: 100, primaryColor: Colors.blue, size: 30),
        ],
      ),
    );
  }
