...
class WidgetStyles {
  static List<WidgetStyleOption> get all => [
    ...
    const WidgetStyleOption(
      name: 'coral',
      displayTitle: 'Coral',
      backgroundColor: AppColors.coralWidget,
      textColor: AppColors.coralTextColor,
      androidWidgetName: 'StikiWidgetLight',
    ),
    const WidgetStyleOption(
      name: 'blush',
      displayTitle: 'Blush',
      backgroundColor: AppColors.blushWidget,
      textColor: AppColors.blushTextColor,
      androidWidgetName: 'StikiWidgetLight',
    ),
    const WidgetStyleOption(
      name: 'lavender',
      displayTitle: 'Lavender',
      backgroundColor: AppColors.lavenderWidget,
      textColor: AppColors.lavenderTextColor,
      androidWidgetName: 'StikiWidgetLight',
    ),
    const WidgetStyleOption(
      name: 'sky',
      displayTitle: 'Sky',
      backgroundColor: AppColors.skyWidget,
      textColor: AppColors.skyTextColor,
      androidWidgetName: 'StikiWidgetLight',
    ),
    const WidgetStyleOption(
      name: 'mint',
      displayTitle: 'Mint',
      backgroundColor: AppColors.mintWidget,
      textColor: AppColors.mintTextColor,
      androidWidgetName: 'StikiWidgetLight',
    ),
    const WidgetStyleOption(
      name: 'sage',
    ...
    const WidgetStyleOption(
      name: 'slate',
      displayTitle: 'Slate',
      backgroundColor: AppColors.slateWidget,
      textColor: AppColors.slateTextColor,
      androidWidgetName: 'StikiWidgetLight',
    ),
  ];
